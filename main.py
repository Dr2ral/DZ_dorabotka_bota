...
async def get_buying_list(message):
        with (open('files/product1.png', 'rb') as img, open('files/product2.jpg', 'rb') as img2,
              open('files/product3.jpg', 'rb') as img3, open('files/product4.jpg', 'rb') as img4):
            files = [img, img2, img3, img4]
            count = 0
            for k in files:
                count += 1
                await message.answer(f'Название: Product{count} | Описание: описание {count} | Цена: {count * 100}')
                await message.answer_photo(k)
